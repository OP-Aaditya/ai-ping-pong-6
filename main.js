...
{
   game_status = "start";
    document.getElementById("status").innerHTML="Model is Loaded" ; //Update the h3 tag which we have created inside index.html file in project 138 who has id “status” to "Game Is Loaded”.
}
